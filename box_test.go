...
func TestValue(t *testing.T) {
	...
	assert(Float64(math.Inf(+1)).Int() == math.MaxInt64)
	assert(Float64(math.Inf(-1)).Int() == math.MinInt64)
	assert(Float64(math.Inf(+1)).Uint() == math.MaxUint64)
	assert(Float64(math.Inf(-1)).Uint() == 0)
